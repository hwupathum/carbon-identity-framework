...
public class SAMLSSOServiceProviderConstants {
    ...
    public static class SqlQueries {
        ...
        public static final String UPDATE_SAML2_SSO_CONFIG_BY_ID = "UPDATE IDN_SAML2_SSO SET " +
        ...
        public static final String GET_SAML2_SSO_CONFIG_BY_ISSUER = "SELECT ID, ISSUER, DEFAULT_ASSERTION_CONSUMER_URL, " +
