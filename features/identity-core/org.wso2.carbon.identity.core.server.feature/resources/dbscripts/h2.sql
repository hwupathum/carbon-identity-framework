...
CREATE TABLE IF NOT EXISTS IDN_SAML2_SSO_CONFIGS (
    ISSUER_ID VARCHAR(255) NOT NULL,
    TENANT_UUID CHAR(36) NOT NULL,
    ISSUER VARCHAR(255),
    ASSERTION_CONSUMER_URLS VARCHAR(255),
    ...
    NAME_ID_CLAIM_URI VARCHAR(255),
    DO_SINGLE_LOGOUT BOOLEAN,
    SLO_RESPONSE_URL VARCHAR(255),
    SLO_REQUEST_URL VARCHAR(255),
    DO_FRONT_CHANNEL_LOGOUT BOOLEAN,
    FRONT_CHANNEL_LOGOUT_BINDING VARCHAR(255),
    DO_SIGN_RESPONSE BOOLEAN,
    ASSERTION_QUERY_REQUEST_PROFILE_ENABLED BOOLEAN,
    SUPPORTED_ASSERTION_QUERY_REQUEST_TYPES VARCHAR(255),
    ENABLE_SAML2_ARTIFACT_BINDING BOOLEAN,
    DO_SIGN_ASSERTIONS BOOLEAN,
    ENABLE_ECP BOOLEAN,
    REQUESTED_CLAIMS VARCHAR(255),
    ATTRIBUTE_CONSUMING_SERVICE_INDEX VARCHAR(255),
    REQUESTED_AUDIENCES VARCHAR(255),
    REQUESTED_RECIPIENTS VARCHAR(255),
    ENABLE_ATTRIBUTES_BY_DEFAULT BOOLEAN,
    IDP_INIT_SSO_ENABLED BOOLEAN,
    IDP_INIT_SLO_ENABLED BOOLEAN,
    IDP_INIT_SLO_RETURN_URLS VARCHAR(255),
    DO_ENABLE_ENCRYPTED_ASSERTION BOOLEAN,
    ...
    PRIMARY KEY (ISSUER_ID, TENANT_UUID),
    UNIQUE(ISSUER)
);
